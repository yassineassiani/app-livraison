...
class Singupd extends StatefulWidget {
  const Singupd({super.key});

  @override
  State<Singupd> createState() => _SingupdState();
}

class _SingupdState extends State<Singupd> {
  bool pt = true;
    ...
    return Material(
      child: SingleChildScrollView(
        ...
        children: [
          ...
          Container(
            child: const Text(" Account Delivery",
                style: TextStyle(
                   fontFamily:"CustomFont" ,
